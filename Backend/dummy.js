...
//   const newProducts=[...products].filter(p=>p.category==="electronics")
//   if
//   return newProducts
...
console.log(a())
// const getRandomValue=(initial,final)=>{
//     return (Math.random()*(final-initial)+initial).toFixed(1)
// }
// function addEntry(object,key,value){
//     return {...object,[key]:value}
// }
// const key="rating"
// let newComments=comments.map(p=>{
//     const value=getRandomValue(0,5)
//     return addEntry(p,key,value)
// })

// function printallnewValues(){
//     newComments.forEach(element => {
//         console.log(element)
//     });
// }
// console.log(printallnewValues())